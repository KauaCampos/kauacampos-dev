...
export const projectsByLang: Record<Language, Project[]> = {
  pt: [
    ...
    { title: 'SIGEPP', year: '2024', description: 'Sistema integrado de gestão acadêmica com arquitetura backend modular e fluxo de dados consistente para operações de estágio e pesquisa.', stack: ['Spring Boot', 'Java', 'NoSQL', 'HTML', 'CSS', 'JavaScript'], github: 'https://github.com/KauaCampos', demo: '#', featured: true, image: projectSigepp },
  ...
  en: [
    ...
    { title: 'SIGEPP', year: '2024', description: 'Integrated academic management system with modular backend architecture and a consistent data flow for internship and research operations.', stack: ['Spring Boot', 'Java', 'NoSQL', 'HTML', 'CSS', 'JavaScript'], github: 'https://github.com/KauaCampos', demo: '#', featured: true, image: projectSigepp },
