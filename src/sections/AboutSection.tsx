    ...
    <section id="sobre" className="mx-auto max-w-6xl px-6 py-20">
      ...
      <div className="mt-8 grid gap-6 lg:grid-cols-2">
        <article className="rounded-2xl border border-white/10 bg-white/5 p-6 text-slate-300">
          ...
          <p className="mt-4">
            No Prisma Software Factory, participei da construção de soluções para a ONG INASIM; no SIGEPP, aprofundei em Spring Boot, banco de dados e integração full stack. Meu interesse atual está em desenvolvimento fullstack, backend, arquitetura e IA aplicada a produtos úteis.
          </p>
        </article>
